    ...
    <div class="row">
        ...
        <div class="col-md-4" id="sidebar">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <span class="label label-success">F5</span>֊ը նախատեսված է էջը նորից բեռնելու համար, այլ բառերով
                    ասած էջը թարմացնելու համար։
                    <br>
                    <br>
                </div>
            </div>
            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <ol>
                        <li><span class="label label-success">F5</span>-ով մի քանի անգամ թարմացրու էջը, ամեն անգամ
                            ստանալով նոր աֆորիզմ։
                    </ol>
                </div>
            </div>
        </div>
