...
<html lang="hy_am">
  <head>
    ...
    <title>ԱնՄուկ | Ֆորմայի լրացում</title>
  ...
  <body>
    ...
    <script>
      ...
      $("#name").change(function(){
        name = $(this).val()!="" ? true:false;
        checkAndActivate();
      })
      
      $("#fname").change(function(){
        fname = $(this).val()!="" ? true:false;
        checkAndActivate();
      })
      ...
      $("#date").change(function(event) {
          date = $(this).val()=="2014-09-30" ? true:false;
          checkAndActivate();      
      });

      $("#color").change(function(event) {
          color = $(this).val()=="#ff0000" ? true:false;
          checkAndActivate();      
      });


      $("#check1").change(function(event) {
          check1 = $(this).prop('checked')==true ? true:false;
          checkAndActivate();      
      });
      
      $("#check2").change(function(event) {
          check2 = $(this).prop('checked')==false ? true:false;
          checkAndActivate();
      });

      $("#range").change(function(){
        range=$(this).val()=="73" ? true:false;
        checkAndActivate();
      })      
