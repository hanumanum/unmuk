  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="page-header row">
        ...
        <div class="col-md-11">
          <h1>Ան-Մուկ</h1>
          <p>Աշխատանք <span class="label label-success">Home</span> և <span class="label label-success">End</span> ստեղներով</p>
      </div>
      </div>
      ...
      <div class="row">
        ...
        <div class="panel panel-success">
          ...
          <div class="panel-body">
            <span class="label label-success">Home</span> և <span class="label label-success">End</span> ստեղները նույնպես նավարկման ստեղներ են։ Այս ստեղների ֆունկցիաները կախված են կոնտեքստից։
            <br> <br>
            <ul>
              <li>
        ...
        <div class="panel panel-danger">
          ...
          <div class="panel-body">
            <ol>
              <li>Մի քանի անգամ սեղմիր <span class="label label-success">Home</span> և <span class="label label-success">End</span> ստեղներին</li>
              <li>Կուրսորը հերթով տեղադրիր Տեքստային դաշտում գտնվող տեքստի տարբեր տողերում , ապա սեղմիր <span class="label label-success">Home</span> և <span class="label label-success">End</span> ստեղներին</li>
            </ol>
          </div>
        </div>
