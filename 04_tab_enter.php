...
<head>
    ...
    <title>Ան֊Մուկ | Աշխատանք Tab, Shift+Tab և Enter ստեղներով</title>
...
<div class="container-fluid">
    <div class="page-header row">
        ...
        <div class="col-md-11">
            <h1>Ան-Մուկ</h1>
            <p><span class="label label-success">TAB</span> և <span class="label label-success">Enter</span> ստեղները և
                <span class="label label-success">Shift+Tab</span> համադրությունը</p>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <a href="04_tab_enter.php" id="havayi" data-toggle="tooltip" title="asdfsd"
        ...
        <div class="col-md-4" id="sidebar">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    <span class="label label-success">Tab</span> ստեղնի միջոցով կարելի է տեղափոխվել էջի ներսում գտնվող
                    ակտիվ էլեմենտների վրայով։
                </div>
            </div>
            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <ol>
                        <li>Հիմա փորձիր սեղմել <span class="label label-success">Tab</span>-ին մի քանի անգամ և հասկանալ
                            թե ինչ է կատարվում։
                        </li>
