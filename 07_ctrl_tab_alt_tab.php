      ...
      <div class="row">
        ...
        <div class="panel panel-success">
          ...
          <div class="panel-body">
            <span class="label label-success">Ctrl+Tab</span> և <span class="label label-success">Alt+Tab</span> ստեղնաշարային հղումների միջոցով կարելի է նավարկել բացված պատուհանների կամ պատուհանների ներդիրների միջև։
            <br><br>
            <ul>
